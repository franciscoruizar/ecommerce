...
import ar.franciscoruiz.apps.backoffice.backend.BackofficeBackendApplication;
import ar.franciscoruiz.apps.backoffice.frontend.BackofficeFrontendApplication;
import ar.franciscoruiz.apps.retention.backend.RetentionBackendApplication;
...
public class Starter {
    ...
    private static HashMap<String, Class<?>> applications() {
        ...
        applications.put("retention_backend", RetentionBackendApplication.class);
    ...
    private static HashMap<String, HashMap<String, Class<?>>> commands() {
        ...
        commands.put("retention_backend", RetentionBackendApplication.commands());
