package ar.franciscoruiz.apps.backoffice.frontend.config;
...
@Configuration
@EnableWebMvc
public class BackendFrontendWebConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/**").addResourceLocations("classpath:/templates/mooc_frontend/public/");
    }
